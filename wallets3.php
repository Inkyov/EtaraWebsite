...
Where productID IN (124, 127, 130, 133, 136, 139, 142, 145, 148)";
...
echo "<ul class='pagination'>";
  echo "<li><a href='wallets2.php'>«</a></li>";
  echo "<li><a href='wallets.php'>1</a></li>";
  echo "<li><a href='wallets2.php'>2</a></li>";
  echo "<li><a class='active' href='wallets3.php'>3</a></li>";
  echo "<li><a href='wallets4.php'>4</a></li>";
  echo "<li><a href='wallets4.php'>»</a></li>";
echo "</ul>";
