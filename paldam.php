...
if($num>0){
      ...
      echo "<div id='details'>";
            ...
            echo "<p><span class='info1'>Описание: </span><span class='info2' id='beige'>{$Description}</span></p><br/>";
            echo "<p>Вид материал: <select id='selectMaterial{$ProductID}' class='select{$ProductID}'>
            ...
            echo "<p><span class='info1'>Наличност: </span><span class='info2' id='beige'>{$Stock}</span></p><br/>";
                    echo "<p><span class='info1'>&nbsp</span>";
                        echo "<span class='info2' id='beige'><input type='number' min='1' max='5' name='quantity' id='quantity' maxlendth='5' value='1' class='form-control' />";
