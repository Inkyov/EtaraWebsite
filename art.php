...
if($num>0){
      ...
      echo "<div id='details'>";
            ...
            echo "<p class='material'><span class='info1'>Вид материал: </span><span class='info2' id='beige'>{$Material}</span></p>";
...
if($num>0){
      ...
      echo "<div id='details'>";
            ...
            echo "<p><span class='info1'>Вид материал: </span><span class='info2' id='beige'>{$Material}</span></p>";
            echo "<p><span class='info1'>Цвят: </span><span class='info2'><select id='selectColor{$ProductID}' class='select{$ProductID}'>
                  <option value='natural'>Натурален</option>
                  <option value='black'>Черен</option>
                  </select></span>
