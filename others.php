...
if($num>0){
      ...
      echo "<div id='details'>";
            ...
            echo "<p><span class='info1'>Описание: </span><span class='info2'><select id='selectDescription{$ProductID}' class='select{$ProductID}'>
                  <option value='rapidi'>Юлар за кон - ръчно шит с рапиди</option>
                  <option value='sarum'>Юлар за кон - ръчно шит със саръм (свинска, ярешка кожа)</option>
                  </select></span>
                  </p>";
...
LEFT JOIN names ON productsonesize.nameID=names.nameID
LEFT JOIN description ON productsonesize.DescriptionID=description.descriptionID
Where productID IN (42, 54, 58, 62, 66)";
